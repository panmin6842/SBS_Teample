...
public static class EnemyConstant
{
    ...
    public static readonly float RETREAT_DISTANCE = 2.0f;
    /// <summary>
    /// 4.0f로 설정된 RETREAT_DISTANCE의 제곱 값입니다. 이 값은 적이 얼마나 후퇴해야 다음 행동을 취할 수 있는지 판단하는 데 사용됩니다.
    /// </summary>
    public static readonly float RETREAT_DISTANCE_SQUARED = RETREAT_DISTANCE * RETREAT_DISTANCE;
